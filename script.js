...
function navigateToSiteAbout(e, t) {
    window.innerWidth;
    let o = document.querySelector(".whole-screen");
    o.style.animationDirection = "reverse",
    o.style.display = "flex",
...
function handleHash() {
    let e = window.location.hash.slice(1).split("-");
    2 === e.length && initImages(e[0], parseInt(e[1])),
    1 === e.length && scrollToPosition(e)
}
...
function loaded() {
    let w = document.querySelector(".whole-screen");
    w.style.animationDirection = "forwards",
